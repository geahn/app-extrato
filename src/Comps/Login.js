            ...
            <div className="boxed auth-tela">
                ...
                <div className="card card-mini m4">
                    <div className="linksauth">
                        <a href="/login" className="selectauth">Login</a>
                        <a href="/cadastro">Cadastro</a>
                        <hr />
                    </div>
                    <p>Seja bem-vindo, faça seu login!</p>
                    <div className="msgerro hide">
                    ...
                    <form onSubmit={this.aoEnviar}>
                        <div className="inputicon">
                            ...
                            <input type="text" id="usuario" name="usuario" placeholder="Usuário"
                              value={this.state.usuario_login} onChange={this.aoMudarUsuario}></input>
                        </div>

                        <div className="inputicon">
                            <ion-icon name="key-sharp"></ion-icon>
                            <input type="password" id="senha" name="senha" placeholder="Senha"
                              value={this.state.senha_login} onChange={this.aoMudarSenha}></input>
                        </div>

                        <button type="submit">
                            Entrar <ion-icon name="enter"></ion-icon></button>
                    </form>
                </div>
            </div>
        )
